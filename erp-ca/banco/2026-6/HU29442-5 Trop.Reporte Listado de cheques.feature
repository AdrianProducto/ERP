Feature: Tropicalizacion del reporte "Listado de Cheques" del modulo de bancos

    Yo como usuario del reporte Listado de Cheques del modulo de bancos
    Requiero que el reporte se encuentre adaptado para el uso con moneda de quetzales
    Para que el reporte encaje con las actividades realizadas en el pais de guatemala.

Background:
    Given que el usuario se encuentra dentro de una base de datos del pais de guatemala
    And ingresa al reporte "Listado de cheques"
...
Scenario: Lectura de moneda Quetzal en columnas de moneda
    ...
    #Actualmente la columna se visualiza vacia en registros realizados en quetzales.
...
Scenario: Aplicar ajustes de exportacion a PDF
    Given que el usuario exporta el reporte "Listado de cheques" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
    Then la columna de moneda debe de leer el tipo de moneda "Quetzales"

Scenario: Cambiar etiqueta "RFC" a "NIT" en formato PDF
    Given que el suario exporta el reporte "Listado de cheques" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
    Then el reporte muestra ahora la etiqueta "NIT" en lugar de "RFC" en el encabezado del reporte en PDF

Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Listado de cheques" del módulo de bancos en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el reporte "Listado de cheques" en el listado de reportes del modulo de bancos.