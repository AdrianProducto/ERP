Feature: Tropicalizacion del reporte "Radiografía de Viaje por Unidad por Unidad" del modulo de informes gerenciales

    Yo como usuario del reporte Radiografía de Viaje por Unidad por Unidad del modulo de informes gerenciales
    Requiero que el reporte se encuentre adaptada para el uso con moneda de quetzales
    Para que el reporte encaje con las actividades realizadas en el pais de guatemala.

Background:
    Given que el usuario se encuentra dentro de una base de datos del pais de guatemala
    And ingresa al reporte "Radiografía de Viaje por Unidad por Unidad"
...
Scenario Outline: Aplicar ajustes en exportación a Excel
  Given que el usuario exporta el reporte "Radiografía de Viaje por Unidad" a Excel con la opcion "Exportar XLS"
...
Scenario: Aplicar ajustes de exportacion a PDF
    Given que el usuario exporta el reporte "Radiografía de Viaje por Unidad" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
...
Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Radiografía de Viaje por Unidad" del módulo de informes gerenciales en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el reporte "Radiografía de Viaje por Unidad" en el listado de reportes del modulo de informes gerenciales.