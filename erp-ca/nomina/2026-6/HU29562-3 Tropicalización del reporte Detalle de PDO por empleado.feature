Feature: Tropicalizacion del reporte "Detalle de PDO por empleado" del modulo de nominas

    Yo como usuario del reporte de Detalle de PDO por empleado del modulo de nominas
...
Background: 
    ...
    And ingresa al reporte de Detalle de PDO por empleado del modulo de nominas
...
Scenario Outline: Aplicar ajustes en exportación a Excel
  Given que el usuario exporta el reporte "Detalle de PDO por empleado" a Excel con la opcion "Exportar XLS"
...
Scenario: Aplicar ajustes de exportacion a PDF
    Given que el usuario exporta el reporte "Detalle de PDO por empleado" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
...
Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Detalle de PDO por empleado" del módulo de nomina en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el reporte "Detalle de PDO por empleado" en el listado de reportes del modulo de nomina. 