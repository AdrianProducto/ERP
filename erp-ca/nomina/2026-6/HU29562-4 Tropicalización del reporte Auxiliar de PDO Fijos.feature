Feature: Tropicalizacion del reporte "Auxiliar de PDO Fijos" del modulo de nominas

    Yo como usuario del reporte de Auxiliar de PDO Fijos del modulo de nominas
...
Background: 
    ...
    And ingresa al reporte de Auxiliar de PDO Fijos del modulo de nominas
...
Scenario Outline: Aplicar ajustes en exportación a Excel
  Given que el usuario exporta el reporte "Auxiliar de PDO Fijos" a Excel con la opcion "Exportar XLS"
...
Scenario: Aplicar ajustes de exportacion a PDF
    Given que el usuario exporta el reporte "Auxiliar de PDO Fijos" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
...
Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Auxiliar de PDO Fijos" del módulo de nomina en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el reporte "Auxiliar de PDO Fijos" en el listado de reportes del modulo de nomina. 