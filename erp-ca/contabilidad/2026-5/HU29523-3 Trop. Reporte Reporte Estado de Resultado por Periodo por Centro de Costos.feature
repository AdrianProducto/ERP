Feature: Tropicalizacion del reporte "Estado de Resultado por Periodo por Centro de Costos" del modulo de contabilidad

    Yo como usuario de la reporte Estado de Resultado por Periodo por Centro de Costos del modulo de contabilidad
    Requiero que el reporte se encuentre adaptada para el uso con moneda de quetzales
    Para que el reporte encaje con las actividades realizadas en el pais de guatemala.

Background:
    Given que el usuario se encuentra dentro de una base de datos del pais de guatemala
    And ingresa al reporte "Estado de Resultado por Periodo por Centro de Costos"
...
Scenario Outline: Aplicar ajustes en exportación a Excel
  Given que el usuario exporta el reporte "Estado de Resultado por Periodo por Centro de Costos" a Excel con la opcion "Exportar XLS"
...
Scenario: Aplicar ajustes de exportacion a PDF
    Given que el usuario exporta el reporte "Estado de Resultado por Periodo por Centro de Costos" a PDF con la opcion "Imprimir PDF"
    When abre el archivo generado
...
Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Estado de Resultado por Periodo por Centro de Costos" del módulo de contabilidad en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el reporte "Estado de Resultado por Periodo por Centro de Costos" en el listado de reportes del modulo de contabilidad.