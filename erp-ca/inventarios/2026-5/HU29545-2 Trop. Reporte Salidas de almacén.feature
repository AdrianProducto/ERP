Feature: Tropicalizacion del reporte "Salidas de almacén" del modulo de inventarios

    Yo como usuario de la reporte Salidas de almacén del modulo de inventarios
    Requiero que el reporte se encuentre adaptada para el uso con moneda de quetzales
    Para que el reporte encaje con las actividades realizadas en el pais de guatemala.

Background:
    Given que el usuario se encuentra dentro de una base de datos del pais de guatemala
    And ingresa al reporte "Salidas de almacén"
...
Scenario: Cambiar etiqueta "RFC" a "NIT" en formato HTML
    Given que el sistema exporta el reporte "Salidas de almacén" a HTML
...
Scenario Outline: Aplicar ajustes en exportación a Excel
  Given que el usuario exporta el reporte "Salidas de almacén" a Excel con la opcion "Generar XLS"
...
Scenario: Mantener comportamiento actual del reporte para bases de datos de México
  Given que el usuario accede al reporte "Salidas de almacén" del módulo de bancos en una base de datos de México
...
Scenario: El reporte es visible en base de datos de guatemala.
  ...
  Then el sistema debera de mostrar el "Salidas de almacén" en el listado de reportes del modulo de bancos.