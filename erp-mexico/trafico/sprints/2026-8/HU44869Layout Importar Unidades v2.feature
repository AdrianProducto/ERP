@Jaqueline @HU37413 @ImportarUnidades
Feature: Importación masiva de catálogo de unidades

    Yo como usuario de implementación
    requiero que se puedan importar unidades masivamente desde un archivo Excel
    Para que pueda configurar el catálogo sin captura manual, incluyendo los nuevos campos de Carta Porte SAT
    ...
    Scenario: Importar archivo con algunas filas con error
        ...
        And el sistema muestra el tab "Resultados" con la tabla de errores de las 3 filas fallidas
    ...
    Scenario: Validación de campo TransporteRentadaOPrestada en unidad no rentada
        ...
        And el campo "EsRentada" de esa unidad es falso
