Feature: Mostrar lista de dispersiones
  ...
  Necesito poder consultar las dispersiones de anticipos generadas
  ...
  Scenario: Actualización en derechos de usuario
    ...
    When selecciona el proceso Anticipos
  ...
  Scenario: Mostrar nuevo proceso de dispersión avanzada para anticipos
    Given el usuario se encuentra logueado en el sistema
    When solicite ingresar al listado de anticipos del modulo de tráfico
    And cuente con los permisos sobre el proceso de dispersión avanzada para anticipos
    Then el sistema presenta el boton "Disp. Avanzada" como parte de las opciones del listado

  Scenario: Ocultar nuevo proceso de dispersión avanzada para anticipos
    Given el usuario se encuentra logueado en el sistema
    When solicite ingresar al listado de anticipos del modulo de tráfico
    And no cuenta con los permisos sobre el proceso de dispersión avanzada para anticipos
  ...
  Scenario: Mostrar lista de dispersiones 
    Given el usuario se encuentra en el listado de anticipos
