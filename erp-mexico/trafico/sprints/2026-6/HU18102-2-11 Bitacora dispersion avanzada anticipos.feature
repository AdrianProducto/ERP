Feature: Registrar movimientos en bitácora de dispersion avanzada de anticipos
  ...
  Background: 
    Given el usuario se encuntra en el listado de Ancitipos del modulo de Tráfico
    And cuenta con permisos sobre el proceso de dispersión avanzada de anticipos
  ...
  Scenario: Registrar acción de entrar a proceso de dispersión avanzada
    ...
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
  ...
  Scenario: Registrar accion de asignar operación bancaria
    Given el usuario se encuentra en el proceso asignar operación bancaria
    ...
    And guarda la fecha y hora en la que se realizo la acción
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
    And guarda la descripcion del movimiento "Se asigna operación bancaria"

  Scenario: Registrar accion de cancelar asignación de operación bancaria
    Given el usuario se encuentra en el proceso asignar operación bancaria
    When cancela el proceso
    Then el sistema registra el movimiento en bitacora 
    And guarda al usuario que genero la acción
    And guarda la fecha y hora en la que se realizo la acción
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
    And guarda la descripcion del movimiento "Se cancela asignación de operación bancaria"

  Scenario: Registrar accion de entrar a consultar anticipos
    Given el usuario se encuentra en el listado de dispersiones
    When solicita consultar los anticipos de una dispersión
    Then el sistema registra el movimiento en bitacora 
    And guarda al usuario que genero la acción
    And guarda la fecha y hora en la que se realizo la acción
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
    And guarda la descripcion del movimiento "Entra a consulta de anticipos de la dispersión <descripcion_disp>"

  Scenario: Registrar accion de guardar cambios en dispersión
    Given que se asociaron y/o desasociaron anticipos a la dispersión que esta consultando el usuario
    ...
    And guarda la fecha y hora en la que se realizo la acción
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
    And guarda la descripcion del movimiento "Se asociaron y/o desasociaron anticipos a la dispersión <descripcion_disp>"

  Scenario: Registrar accion de cancela a consultar anticipos
    Given el usuario se encuentra consultando los anticipos de una dispersión 
    When cancela la consulta los anticipos de la dispersión
    Then el sistema registra el movimiento en bitacora 
    And guarda al usuario que genero la acción
    And guarda la fecha y hora en la que se realizo la acción
    And guarda el proceso afectado como "Tráfico/Anticipos/Disp. Avanzada"
    And guarda la descripcion del movimiento "Cancela consulta de anticipos de la dispersión <descripcion_disp>"
