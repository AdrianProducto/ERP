Feature: Generación de R41 en formato JSON con código de evento "T01"
    Yo como usuario de Tráfico,
    Quiero que se genere un documento R41 en formato JSON al momento de crear un viaje con un cliente en donde el estatus del viaje sea el que represente el código de evento "T01",
  ...
  Background:
    Given que el nuevo parámetro "Generar R41 detallado de VINs por JSON" se encuentra habilitado para el cliente del viaje
      ...
      And el usuario haya descrito qué estatus del viaje representa el código de evento "T01" en el catálogo de estatus de viaje

  Scenario: Crear un viaje o modificar un viaje existente y asignarle el estatus con código de evento "T01"
    Given que el usuario se encuentra documentando un viaje con un cliente que tiene habilitado el nuevo parámetro para generar el R41 en formato JSON
      And el usuario quiere asignarle al viaje un estatus que represente el código de evento "T01"
     ...
     When el usuario asigne al viaje un estatus que represente el código de evento "T01"
     Then el sistema generará un documento R41 en formato JSON con la información del viaje y los VINs de los vehículos transportados en ese viaje
          ...
          "R41": [
            {
              ...
              "pickupEta": "2026-07-10T10:00:00-07:00"
            }
          ]
        }
      '''
      ...
      '''
        ...
        "eventDateTime": fecha y hora en la que el viaje alcanzó el estatus con código de evento "T01", respetar la zona horaria de la sucursal donde se está generando el viaje,
        ...
        "loadPos": se tomará del campo "Truck Orientation" de la sección de Info. Adicional VINs en la descripción del material del viaje,
